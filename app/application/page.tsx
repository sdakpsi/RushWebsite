        ...
        <section className="flex flex-1 items-center justify-center px-4 py-12">
          <div className="mx-auto max-w-4xl w-full">
            ...
            <div className="text-center mb-12 animate-slide-down">
              <div
                className="mx-auto h-20 w-20 rounded-full backdrop-blur-sm border border-border shadow-sm flex items-center justify-center mb-6 animate-scale-in"
                style={{ backgroundColor: "hsl(var(--prospect-background) / 0.9)" }}
              >
              ...
              <div className="inline-flex items-center space-x-2 rounded-lg bg-gray-900/90 backdrop-blur-sm border border-border px-4 py-2 shadow-sm">
            ...
            <div className="prospect-card prospect-glass rounded-xl p-8 animate-slide-up shadow-lg border border-border" style={{ animationDelay: '0.3s' }}>
              {APPLICATION_OPEN === 'open' ? (
                ...
                <div className="card-header text-center py-12">
                  <div
                    className="mx-auto h-24 w-24 rounded-full border border-border flex items-center justify-center mb-6"
                    style={{ backgroundColor: "hsl(var(--prospect-background) / 0.9)" }}
                  >
                  ...
                  <div
                    className="border border-border rounded-lg p-6 max-w-2xl mx-auto text-left"
                    style={{ backgroundColor: "hsl(var(--prospect-background) / 0.9)" }}
                  >
                ...
                <div className="card-header text-center py-12">
                  <div className="mx-auto h-24 w-24 rounded-full bg-red-900/30 border border-red-700 flex items-center justify-center mb-6">
