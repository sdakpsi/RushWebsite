...
export default function NameForm() {
  ...
  const [proudAccomplishment, setProudAccomplishment] = useState('');
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="pronouns">
            Pronouns:
          </label>
          <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="yearInCollege">
            Year in College:
          </label>
          <select
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="graduationYear">
            Graduation Year:
          </label>
          <select
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="graduationQuarter">
            Graduation Quarter:
          </label>
          <select
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="major">
            Major:
          </label>
          <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="minor">
            Minor:
          </label>
          <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="cumulativeGPA">
            Cumulative GPA:
          </label>
          <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-center"
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="currentClasses">
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="extracurricularActivities">
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="proudAccomplishment">
            What accomplishment are you most proud of (personal or professional)? (500 words max)
          </label>
          <textarea
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32"
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="joinReason">
            Why do you want to join Alpha Kappa Psi? What do you seek to gain from this fraternity? What do you expect to be able to add to our community? (500 words max)
          </label>
          <textarea
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32"
            id="joinReason"
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="lifeGoals">
            What are your current life goals (personal or professional) and how do you believe Alpha Kappa Psi will help you achieve those goals? (500 words max)
          </label>
          <textarea
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32"
            id="lifeGoals"
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="comfortZone">
            Tell us about a time you went out of your comfort zone. Why did you decide to take this risk and what did you learn? (500 words max)
          </label>
          <textarea
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32"
            id="comfortZone"
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="businessType">
            What type of business would you create if money was not a limiting factor? (500 words max)
          </label>
          <textarea
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32"
            id="businessType"
        ...
        <div className="col-span-2 mb-4">
          <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="additionalDetails">
      ...
      <div className="flex justify-between mb-6">
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline" type="button">
          Upload Cover Letter
        </button>
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline" type="button">
          Upload Resume
      ...
      <button className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline w-full" type="submit">
        Submit
      </button>
    </form>
  );
